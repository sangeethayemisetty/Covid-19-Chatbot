...
def processRequest(req):
    ...
    cust_name=parameters.get("customer_name")
    cust_contact = parameters.get("customer_contact")
    cust_email=parameters.get("customer_mail")
    cust_pincode= parameters.get("customer_pincode")
    ...
    if (intent=='localcovidinfo'):
        ...
        uploaded = upload_to_aws(file_name+'.jpg', 'covid-19-news', file_name+'.jpg', 'jpg')
...
#                {
 ...
 #       }
        ...
        #call function to upload in Amazon S3 bucket
        uploaded = upload_to_aws(file_name+'.html', 'covid-19-news', file_name+'.html', 'html')
